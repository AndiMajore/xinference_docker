...
#xinference launch --model-name mixtral-instruct-v0.1 --size-in-billions 46_7 --model-format pytorch -u mixtral-8x7B-instruct-v01 --n-gpu 4
xinference launch --model-name llama-2-chat --size-in-billions 13 --model-format pytorch --quantization none  --n-gpu 2
xinference launch --model-name gemma-it --size-in-billions 7 --model-format pytorch --quantization none --n-gpu 1
